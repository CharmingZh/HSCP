...
for numNeuron = 1:100
    ...
    disp(['This is ', num2str(numNeuron), ' round'])
    ...
    for z=1:50
        ...
        NumberofHiddenNeurons = 50 * numNeuron;
    ...
    disp(['Number of Hidden Neurons : ', num2str(NumberofHiddenNeurons)]);
    disp(['       Training Accuracy : ', num2str(TrainingAccuracy)]);
    disp(['       Testing  Accuracy : ', num2str(TestingAccuracy)]);
    resultACC(numNeuron) = TestingAccuracy;
    %plot(numNeuron, TestingAccuracy, 'r+-');
